...
|------|-----|--------------|
| Primary | `#2C8A55` | `--color-primary` |
| Secondary | `#185637` | `--color-secondary` |
| CTA/Accent | `#E6AD20` | `--color-cta` |
| Background | `#F4F8F5` | `--color-background` |
| Text | `#123826` | `--color-text` |

**Color Notes:** Forest green from logo + gold accents
